...
class AnnotatedSubscriberFinder {
     ...
     * {@inheritDoc}
     * <p>
     * This implementation finds all methods marked with a {@link com.google.common.eventbus.Subscribe} annotation.
     */
                ...
                if (superClazzMethod.isAnnotationPresent(Subscribe.class) && !superClazzMethod.isBridge()) {
                    ...
                    if (parameterTypes.length != 1) {
                        throw new IllegalArgumentException(
                                "Method " + superClazzMethod + " has @Subscribe annotation, but requires "
     ...
     * {@link com.google.common.eventbus.AllowConcurrentEvents} annotation.
     *
    ...
    static class SynchronizedEventSubscriber extends EventSubscriber {
        /**
