 ...
 * @author yangzhenye
 */
public class ChoiceFillBlankTemplate extends TemplateFtl{

	public static ChoiceFillBlankTemplate instance(){
				ChoiceFillBlankTemplate t=new ChoiceFillBlankTemplate();
			return t;
	}
	public String outTemplate(ComplexQuestionDto dto,
			QuestionViewDto questionViewDto) throws IOException, TemplateException{
		String fileName="questions/choiceFillBlankQuestion.ftl";
