...
//        String blogURL = "http://cloud.trunk.koolearn.com/teacher/exam/core/paper/preview/?paperId=6149";
//
//        // 直接把网页内容转为PDF文件
//        String pdfFile = "D:\\tol\\data\\urlpdf.pdf";
//        Demo4URL2PDF.parseURL2PDFFile(pdfFile, blogURL);
        String html = "<html><head><title>First parse</title></head>"
                + "<body><div class='jp-question-box'><p>Parsed HTML into a doc.</p><p>Parsed HTML into a doc.</p></div></body></html>";
        org.jsoup.nodes.Document doc = Jsoup.parse(html);
        Elements entry = doc.getElementsByClass("jp-question-box");
        // 把网页内容转为PDF中的Elements
//        String pdfFile2 = "D:\\tol\\data\\urlpdf2.pdf";
...
//        info[2] = dateStr;
        Elements entry = doc.getElementsByClass("jp-question-box");
        info[3]= HtmlCssUtil. delHTMLTag(entry.toString());
        return info;
    }
    ...
    public static void parseURL2PDFFile(String pdfFile, String blogURL)
        ...
        Section section = chapter
                .addSection(new Paragraph(blogInfo[0], secFont)).addSection(new Paragraph(blogInfo[3], secFont));
