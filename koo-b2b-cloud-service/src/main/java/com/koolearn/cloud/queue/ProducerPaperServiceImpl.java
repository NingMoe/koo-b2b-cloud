 ...
 * queue消息生成者
 */
public class ProducerPaperServiceImpl implements ProducerService{
	private static final transient Logger log = LoggerFactory.getLogger(ProducerPaperServiceImpl.class);
