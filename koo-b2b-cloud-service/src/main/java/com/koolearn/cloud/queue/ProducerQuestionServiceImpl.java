 ...
 * queue消息生成者
 */
public class ProducerQuestionServiceImpl implements ProducerService{
	private static final transient Logger log = LoggerFactory.getLogger(ProducerQuestionServiceImpl.class);
