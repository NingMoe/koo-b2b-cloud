...
@Controller
@RequestMapping("/operation/core/resource/preview/")
public class OperationResourcePreviewController {

    private final static Logger logger = Logger.getLogger(OperationResourcePreviewController.class);
    ...
    public String reader(ModelMap modelMap, @PathVariable Integer resourceId, OperationUser user) throws Exception {
        if (resourceId == null) {
        ...
        String pageUrl = ResourceReaderUtil.getPageUrl(ResourceReaderUtil.READER_URL_TYPE_O_R,resource,modelMap);
