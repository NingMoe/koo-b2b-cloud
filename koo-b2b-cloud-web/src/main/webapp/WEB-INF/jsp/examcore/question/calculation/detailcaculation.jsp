...
<form action="<%=request.getContextPath()%>/question/base/essay/detail/1?questionType=<%=Question.QUESTION_TYPE_FILL_CALCULATION%>" method="post">
</form>
<c:if test="${step==1}">
		...
		%>
		<%-- <%@ include file="detailcaculation.inc"%> --%>
