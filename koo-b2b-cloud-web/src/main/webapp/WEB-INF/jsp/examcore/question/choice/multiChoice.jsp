...
<body >
<form action="<%=request.getContextPath()%>/question/base/choice/saveMulti" method="post">
<div class="wp1">
	<c:if test="${choiceQuestionDto.questionDto.responseType==1}">
	<div class="fml">
		<span class="tit"><em class="rd">*</em>子题题型：</span>
		<select name='' disabled="disabled">
			<option value="1">普通多选</option>
		</select>
	</div>
	</c:if>
	...
	<div class="fmbx fmbx1 fmone fc">
		...
		<ul>
			...
			<% int i=0; %>
				...
				<li>
					<input type="checkbox" class="fl cbx1" name="isright" value='${name.isright}' />&nbsp; <span class="xh"><%=(char)(65+i)%></span><input type="text" name="fmbx1_<%=(char)(97+i++)%>" value="<c:out value="${name.description}"></c:out>" class="ipt wh1"/><span class="fn"><a href="javascript:;" class="add"></a><a href="javascript:;" class="remove"></a><a href="javascript:;" class="up"></a><a href="javascript:;" class="down"></a></span><a href="javascript:;" class="a1 bjk">编辑框</a>
			...
			<c:otherwise>
			<li>
				<input type="checkbox" class="fl cbx1" name="isright" value="" />&nbsp;<span class="xh">A</span><input type="text" name="fmbx1_a" class="ipt wh1" value=""/><span class="fn"><a href="javascript:;" class="add"></a><a href="javascript:;" class="remove"></a><a href="javascript:;" class="up"></a><a href="javascript:;" class="down"></a></span><a href="javascript:;" class="a1 bjk">编辑框</a>
				<span class="error1">答案不能为空</span>
				<span class="error1">答案长度不能超过900个字符</span>
			</li>
			<li>
				<input type="checkbox" class="fl cbx1" name="isright" value=""/>&nbsp;<span class="xh">B</span><input type="text" name="fmbx1_b" class="ipt wh1" value=""/><span class="fn"><a href="javascript:;" class="add"></a><a href="javascript:;" class="remove"></a><a href="javascript:;" class="up"></a><a href="javascript:;" class="down"></a></span><a href="javascript:;" class="a1 bjk">编辑框</a>
				<span class="error1">答案不能为空</span>
				<span class="error1">答案长度不能超过900个字符</span>
			</li>
			</c:otherwise>
...
<input type="hidden" name="questionDto.question.questionTypeId" value="1"/> 
</form>
</body>
</html>