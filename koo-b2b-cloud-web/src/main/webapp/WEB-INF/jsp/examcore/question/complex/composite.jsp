...
<script type="text/javascript" src="${examctx}/question/public.js"></script>
...
$(function(){
	...
	$("#bhxx1").click(function(){
		ordtk($(".ipta:eq(0)"),$("#tklist1"),true,true);
	});
	$("#bhxx2").click(function(){
		ordtk($(".ipta:eq(0)"),$("#tklist1"),false,true);
	});
...
<body>
<div class="path"><a href="<%=basePath%>pages/index.jsp">首页</a><c:if test="${not empty sessionScope.userTemplateName}"><span>></span>${sessionScope.userTemplateName}</c:if><span>></span><a href="<%=basePath%>pages/menu.jsp">试题管理</a><span>></span><em>手动录入试题_复合听写</em></div>
...
<div class="wp1">
	<div class="fml">
		...
		<input type="hidden" id="type" name="questionType" value="9"/>
