...
<fe:html title="题库-知识点" initSeajs="true" ie="true" defaultHead="<!DOCTYPE html><html>"
    ...
    <%--<input id="jp-section" type="hidden" value="1">--%>
    <input id="urlType" type="hidden" value="1" name="urlType">
    ...
    <div class="i-main fc jp-main">
        ...
        <jsp:include page="/WEB-INF/jsp/examcore/questionlib/questiontop.jsp">
            <jsp:param name="nav" value="<%=GlobalConstant.PAPER_CREATE_TYPE_ZSD%>"/>
                ...
                <dd class="p-chos-dd" id="jp-temp">
                    <div class="p-pd12">
                        <form id="jp-form-chos" enctype="multipart/form-data">
                            <div class="p-psnew"><p>学科</p> <p>学段</p>  </div>
                            <div class="p-selnew">
                            ...
                            <input type="hidden" name="navigation"   value="<%=GlobalConstant.PAPER_CREATE_TYPE_ZSD%>"/>
                            ...
                            <input type="hidden" name="buttonType" id="buttonType" value="<%=QuestionViewDto.button_ype_question_lib%>"/>
                        </form>
                    </div>
