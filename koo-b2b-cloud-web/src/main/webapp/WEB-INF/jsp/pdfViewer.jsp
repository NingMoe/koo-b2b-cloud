...
<!--#endif-->
    ...
    <link rel="stylesheet" href="/pdf.js-master/web/viewer.css"/>
<!--#if !PRODUCTION-->
    <link rel="resource" type="application/l10n" href="locale/locale.properties"/>
<!--#endif-->

<!--#if !(MOZCENTRAL || CHROME || MINIFIED)-->
    <script src="/pdf.js-master/web/compatibility.js"></script>
<!--#endif-->

<!--#if !PRODUCTION-->
    <script src="/pdf.js-master/external/webL10n/l10n.js"></script>
<!--#endif-->

<!--#if !PRODUCTION-->
    <script src="/pdf.js-master/src/shared/util.js"></script>
    <script src="/pdf.js-master/src/shared/annotation.js"></script>
    ...
    <script>PDFJS.workerSrc = '/pdf.js-master/src/worker_loader.js';</script>
<!--#endif-->
...
<!--#if !PRODUCTION-->
    <script src="/pdf.js-master/web/ui_utils.js"></script>
    <script src="/pdf.js-master/web/default_preferences.js"></script>
    <script src="/pdf.js-master/web/preferences.js"></script>
    <script src="/pdf.js-master/web/download_manager.js"></script>
    <script src="/pdf.js-master/web/view_history.js"></script>
    <script src="/pdf.js-master/web/page_view.js"></script>
    <script src="/pdf.js-master/web/thumbnail_view.js"></script>
    <script src="/pdf.js-master/web/text_layer_builder.js"></script>
    <script src="/pdf.js-master/web/document_outline_view.js"></script>
    <script src="/pdf.js-master/web/document_attachments_view.js"></script>
    <script src="/pdf.js-master/web/pdf_find_bar.js"></script>
    <script src="/pdf.js-master/web/pdf_find_controller.js"></script>
    <script src="/pdf.js-master/web/pdf_history.js"></script>
    <script src="/pdf.js-master/web/secondary_toolbar.js"></script>
    <script src="/pdf.js-master/web/presentation_mode.js"></script>
    <script src="/pdf.js-master/web/grab_to_pan.js"></script>
    <script src="/pdf.js-master/web/hand_tool.js"></script>
    <script src="/pdf.js-master/web/overlay_manager.js"></script>
    <script src="/pdf.js-master/web/password_prompt.js"></script>
    <script src="/pdf.js-master/web/document_properties.js"></script>
<!--#endif-->

<!--#if !MINIFIED -->
    <script src="/pdf.js-master/web/debugger.js"></script>
    <script src="/pdf.js-master/web/viewer.js"></script>
<!--#else-->
    ...
    <div id="outerContainer" class="loadingInProgress">
      ...
      <div id="mainContainer">
        ...
        <div id="errorWrapper" hidden='true'>
          ...
          <textarea id="errorMoreInfo" style="overflow:hidden; resize:none;" hidden='true' readonly="readonly"></textarea>
        </div>
      </div> <!-- mainContainer -->
