...
<!DOCTYPE html>
<fe:html title="创建课堂" initSeajs="true" ie="true"
...
<fe:seaConfig>
    ...
    <div class="i-main p-creaclass">
        <div class="p-creatop" id="jp-creatop">
            <h2><b></b><em id="jp-amend-title">修改</em>
                <a class="p-as" href="/teacher/classRoom/index"></a>
            </h2>
            <input id="jp-titleval" class="p-amend" type="text" value=""
                   placeholder="">
        ...
        <div class="p-creacont fc">
            <div class="p-side fl">
                ...
                <div class="p-overfi" id="jp-overfi">
                    <dl class="p-chos">
                        ...
                        <dd class="p-chos-dd" id="jp-temp">
                            <div class="p-pd12">
                                <form id="jp-form-chos" action="/teacher/classRoom/save" method="post">
                                    <div class="p-psnew">
                                        <p>学科</p>
                                        <p>学段</p>
                                        <p>教材版本</p>
                                    ...
                                    <input id="jp-oblig" type="hidden" value="" name="obligatoryId"/><!-- 必修id -->
                                    <input id="jp-examName" type="hidden" value="" name="examName"/><!-- 考试题目 -->
                                    <input id="jp-tagId" type="hidden" value="" name="tagId"/><!-- 树选中节点id -->
                                    <input id="jp-startime" type="hidden" value="" name="startTimeStr"/><!-- 开放时间 -->
                                    <input id="jp-endtime" type="hidden" value="" name="endTimeStr"/><!-- 截止时间 -->
                                    <input id="jp-classesIds" type="hidden" value="${classesId}" name="classesIds"/><!-- 选择班级id -->
                ...
                <div class="p-creatime" id="jp-creatime">
                    ...
                    <p class="p-tims">
                        <input type="text" class="p-set-tim-input jp-set-startime" readonly placeholder="开放时间"
                               name="startTime">
                        <span><i></i>课堂开放后，学生才可以看到课堂内容。</span>
                    </p>

                    <p class="p-tims">
                        <input type="text" class="p-set-tim-input jp-set-endtime" readonly placeholder="截止时间"
                               name="endTime">
                ...
                <ul id="jp-uploadul">
                       <%-- <li class="aaa li_0">
                            <h4>
                                <span>附件:</span>
                                <b>课件：第一课 沁园春 雪</b>
                                <input id="" class="p-amend jp-inpts" type="text" value="" placeholder="课件：第一课 沁园春 雪" name="">
                                <em>确定</em>
                            </h4>
                            <div class="p-as">
                                <a class="p-up bbb" style="display: none" href="javascript:;" onclick="up(0)"></a>
                                <a class="p-down bbb" style="display: none" href="javascript:;" onclick="down(0)"></a>
...
<script type="text/javascript">
    ...
    uploader.on('error', function (message) {
        if ("F_EXCEED_SIZE" == message) {
            window._hintPop.hintFun("最大文件限制为100m，您的文件已超过最大限制");
