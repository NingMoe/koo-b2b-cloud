...
<p class="p-ps">
    <label>完成率：</label>
    <span><i style="width:${ta.rate * 100}%"></i></span>
    <b><fmt:formatNumber value="${ta.rate}" type="number" pattern="#%" /></b>
</p>
<p class="p-ps pdt25">
    <label>未完成名单：</label>${ta.unFinishStudentName}
</p>
...
<form id="j-from" name="j-from" action="/teacher/classRoom/saveComment" method="post">
...
<script>
    ...
    $(".j-submit").on("click", function () {
        ...
        $("#comment").val(inputVal);
        $.ajax({
            url: "/teacher/classRoom/saveComment",
            type: "post",
            dataType: 'json',
