...
<div class="i-main">
    <h2 class="p-user-header p-personadd">
        <span>个人中心</span>
        <a title="返回个人中心" href="/teacher/info/index"></a>
    </h2>
        ...
        <div class="fc p-user">
            ...
            <div class="fr p-user-right">
                <ul>
                    ...
                    <li class="fc">
                        <span class="fl">担任学科：</span>
                        <div class="fl" id="jp-discipline">
                        <c:forEach items="${plist}" var="p">
							<span>${p.rangeName}${p.subjectName}(${p.bookVersionName})</span>
						</c:forEach>
						</div>
                        <a id="jp-ter-subject" href="javascript:;" class="p-b-btn fl">添加</a>
...
<script type="text/javascript">
 seajs.use(['project/b-ms-cloud/1.x/js/t-personal-edit/page'],function(app){
     app.init({
        api: {
          submit: '111',//上传图片
          saveAvatar: '/teacher/info/saveIco',//上传图片
          getSubjectUrl: '/teacher/resource/getAllSubject',
          getGradeUrl: '/teacher/resource/getAllRange?subjectId={subjectId}',
          getBookUrl: '/teacher/resource/getAllBookVersion?rangeId={rangeId}&klbType=0',
          subjectPopUpSave: '/teacher/info/insertBookVersion',
        },
        passwordSaveUrl: '/teacher/info/savePassword',
        nameSaveUrl: '/teacher/info/saveRealName',
        phoneSaveUrl: '/teacher/info/saveMobile',
        emailSaveUrl: '/teacher/info/saveEmail',
