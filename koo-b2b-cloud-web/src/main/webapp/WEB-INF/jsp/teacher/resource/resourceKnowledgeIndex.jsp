...
<fe:seaConfig>
    ...
    <script type="text/javascript">
        ...
        seajs.use('project/b-ms-cloud/1.x/js/t-zyk/page', function (init) {
            init({
                ...
                treeId: "#treeDemo2",//树Id
                getreeId: "treeDemo2",//树Id
    ...
    <div class="i-main fc jp-main">
        <div class="p-side fl jp-side">
            <p class="p-spns fc">
                <span ><a href="/teacher/resource/index?urlType=${urlType}" >章节信息</a></span>
                <span class="cur"><a href="/teacher/resource/knowledgeIndex?urlType=${urlType}" >知识点</a></span>
            </p>
            ...
            <form id="jp-form-chos" enctype="multipart/form-data">
                ...
                <div class="p-tabpre jp-divs">
                    ...
                    <div class="tabs cur">
                        <dl class="p-chos p-compu">
                            <dt class="p-chos-dt jp-chos2">
                                <span>高中物理、新课标新课标新课标</span>
                                <i></i>
                            </dt>
                            <dd class="p-chos-dd" id="jp-temp2">
                                <div class="p-pd12">
                                    <div class="p-psnew">
                                        <p>学科</p>
                                        <p>学段</p>
                                    ...
                                    <div class="p-selnew">
                                        <select class="i-sel1 sel1" id="sel2-show" name="subjectId">
                                            <!-- <option value="1">小学</option> -->
                                        </select>
                                        <select class="i-sel1 sel2" id="sel2-show1" name="rangeId">
                                            <%--<option value="1">语文</option>--%>
                                        </select>
                                    </div>
                                </div>
                                <a class="p-sure jp-sure2" href="javascript:;">确定</a>
                            </dd>
                        </dl>
                        <!-- 章节 -->
                        <div class="p-chapter">
                            <!-- 树 -->
                            <ul id="treeDemo2" class="ztree p-pd15"></ul>
                        </div>
                    </div>
                </div>
                <input id="jp-lyId" type="hidden" value="-1" name="source" />
                <input id="jp-lxId" type="hidden" value="-1" name="type" />
                ...
                <input id="jp-section" type="hidden" value="1" name="klbType">
        ...
        <div class="p-cont fr">
            <c:if test="${urlType == 0}">
                <p class="p-updata">
                    <a class="orange-btn fr" href="/teacher/resource/addResourceIndex">上传资料</a>
                </p>
            </c:if>
            <div class="p-search">
                ...
                <dl class="p-search-dl jp-zyk-search">
                    ...
                    <dd>
                        ...
                        <a class="white-btn-tab" href="javascript:;" data-ly="1">我的资源库</a>
                        <a class="white-btn-tab" href="javascript:;" data-ly="3">公共资源库</a>
                    </dd>
                    <dt>类型</dt>
                    <dd>
                        <a class="white-btn-tab on" href="javascript:;" data-lx="-1">全部</a>
                        <c:forEach items="${typeList}" var="t">
                            <a class="white-btn-tab" href="javascript:;" data-lx="${t.value}">${t.name}</a>
                        </c:forEach>
                    </dd>
                    <dt>格式</dt>
                    <dd>
