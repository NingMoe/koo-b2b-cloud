...
<!DOCTYPE html>
<fe:html title="作业-修改作业" ie="true" initSeajs="true" 
...
<!-- 公共的头部 E-->
    <form id="save">
        ...
        <fieldset id="zyArea">
	    	<input type="hidden" name="paperId" value="${task.paperId}" id="jp-paperid"/>
	    	<input type="hidden" name="examName" value="${task.examName}" id="jp-examname"/>
        </fieldset>
        <fieldset id="bjArea">
        </fieldset>
	<div class="i-main fc">
...
seajs.use(['project/b-ms-cloud/1.x/js/t-zy-bzzy/page'],function(app){
    app.init({
        api:{
            ...
            finishLink:'/teacher/task/modifySave',
            saveLink:'/teacher/task/modifySave',
