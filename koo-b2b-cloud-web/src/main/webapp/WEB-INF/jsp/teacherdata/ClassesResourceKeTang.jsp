            ...
            <div class="fr">
                <div class="p-con">
                    <h2 class="jp-tab fc p-con-h2">
                            ...
                            <a href="javascript:void(0)"  class="fl s"  id="classroom" valueType="2">课堂</a>
                            ...
                            <table class="p-assets-table">
                                ...
                                <c:forEach items="${tpExamClassesList}" var="exam"  varStatus="vs">
                                    <tr>
                                        <td>${vs.index+1}</td>
                                        <td>${exam.typeName}</td>
                                        <td><a href="/teacher/classRoom/previewDetail?classRoomId=${exam.examId}" class="p-lft-txt" title="${ exam.examName}">${ exam.examName}</a></td>
