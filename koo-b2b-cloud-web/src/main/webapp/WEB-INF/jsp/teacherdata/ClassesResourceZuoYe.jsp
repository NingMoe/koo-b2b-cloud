            ...
            <div class="fr">
                <div class="p-con">
                    <h2 class="jp-tab fc p-con-h2">
                        <a href="javascript:void(0)" onclick="showDisInfo( 0 )"  class="fl" id="allZy" valueType="0">全部资源</a>
                        <a href="javascript:void(0)" onclick="showDisInfo( 2 )" class="fl"  id="classroom" valueType="2">课堂</a>
                        <a href="javascript:void(0)" class="fl s"  id="homework" valueType="1">作业</a>
                            ...
                            <table class="p-assets-table">
                                ...
                                <c:forEach items="${tpExamClassesList}" var="exam"  varStatus="vs">
                                    <tr>
                                        <td>${vs.index+1}</td>
                                        <td>${exam.typeName}</td>
                                        <td><a href="/teacher/task/situation?examId=${exam.examId}&classId=${exam.classesId}" class="p-lft-txt" title="${ exam.examName}">${ exam.examName}</a></td>
