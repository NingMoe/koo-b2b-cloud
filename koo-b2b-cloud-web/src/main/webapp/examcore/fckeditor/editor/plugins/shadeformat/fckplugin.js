...
var FCKShadeFormatTextStyle = function( tooltip, style )
{
	if ( tooltip === false )
		return ;
...
FCKShadeFormatTextStyle.prototype = new FCKToolbarSpecialCombo ;

FCKShadeFormatTextStyle.prototype.GetLabel = function()
{
	return FCKLang.Style ;
}

FCKShadeFormatTextStyle.prototype.GetStyles = function()
{
	var styles = {};
	var styleDefs = FCKConfig.KooStyles_ShadeFormat ;
...
FCKShadeFormatTextStyle.prototype.CreateItems = function( targetSpecialCombo )
{
	...
	for ( var styleName in styles )
	{
		...
		var caption = style.GetType() == FCK_STYLE_OBJECT ?
			styleName :
			FCKShadeFormatTextStyle_BuildPreview( style, style.Label || styleName ) ;
...
FCKShadeFormatTextStyle.prototype.RefreshActiveItems = function( targetSpecialCombo )
{
...
FCKShadeFormatTextStyle.prototype.StyleCombo_OnBeforeClick = function( targetSpecialCombo )
{
...
function FCKShadeFormatTextStyle_BuildPreview( style, caption )
{
...
FCKToolbarItems.RegisterItem( 'ShadeFormat'		, new FCKShadeFormatTextStyle( null, FCK_TOOLBARITEM_ONLYTEXT ) ) ;