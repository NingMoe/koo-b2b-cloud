...
function showHelp(id){
	 var pop=new Popup({ contentType:1,isReloadOnClose:false,scrollType:'yes',width:800,height:500});
    pop.setContent("contentUrl","/maintain/help/show/"+id);
    pop.setContent("title","使用帮助");
    pop.build();
    pop.show();
}
