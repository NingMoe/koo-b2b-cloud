...
var
  ...
  , cVideoPlay= 2
  , cOtherElement = 3
  , cDefaultElement = cOtherElement
  ;

//var cFckMediaElementName = 'fckmedia'; //embed | object | fckmedia
var cFckMediaElementName = 'span'; //embed | object | fckmedia
//var cMediaTypeAttrName = 'mediatype';  //lowerCase only!!
var cMediaTypeAttrName = 'span';  //lowerCase only!!

var cWMp6Compatible = true;

//const cDefaultMediaPlayer = 0; //!!!DO NOT Use the constant! the IE do not support const!

var
  cFCKMediaObjectAttrs = {width:1, height:1, align:1, id:1, name:1, 'class':1, className:1, style:1, title:1,src:1}; //the 'class' is keyword in IE!!
...
*/
var cCommPlayer={id:cCommPlayer},cRichPlay={id:cRichPlay},cVideoPlay={id:cVideoPlay},cOtherElement={id:cOtherElement}
var
  oFCKMediaPlayers = [cCommPlayer, cRichPlay,cVideoPlay, cOtherElement];
...
function WrapObjectToMedia(html, aMediaElementName) {
  ...
  var regexMedia = new RegExp( '<'+aMediaElementName+'\s+?class=\"jpy(.+?)><\/'+aMediaElementName+'>', 'gi' );
